...
import top.sy.config.CloopenConfig;
import top.sy.service.SmsService;
...
public class SmsServiceImpl implements SmsService {
    ...
    public void  sendSms(String phone){
        ...
        String[] dates= {String.valueOf(code),"1"};

        HashMap<String, Object> result = sdk.sendTemplateSMS(phone, templateId, dates, "1234", UUID.randomUUID().toString());
